...
export default function WomensStorePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const categoriesResponse = await fetch('/api/categories?section=women');
        const categoriesData = await categoriesResponse.json();
        
        // Fetch women's products
        const productsResponse = await fetch('/api/products?section=women');
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-xl overflow-hidden mb-8">
        <div className="relative h-[300px] md:h-[400px] bg-gradient-to-r from-pink-900 to-pink-600">
          <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-16 text-white">
            ...
            <p className="text-lg md:text-xl max-w-md mb-6">Explore our latest women's fashion collection featuring elegant designs for every occasion.</p>
            <div>
              <button className="px-6 py-3 bg-white text-pink-800 font-medium rounded-lg hover:bg-gray-100 transition-colors">
                Shop Now
              </button>
            </div>
          </div>
        ...
        <div className="lg:w-1/4 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-5">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
              <ListFilter className="w-5 h-5 mr-2 text-pink-600 dark:text-pink-400" />
              Categories
            </h3>
            <div className="space-y-2">
              <div 
                ...
                className={`px-3 py-2 rounded-md cursor-pointer text-sm ${
                  !selectedCategory 
                    ? 'bg-pink-50 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400 font-medium' 
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-gray-100 dark:bg-gray-700 pl-10 pr-8 py-2 rounded-lg text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-pink-500 text-sm"
                >
              ...
              <div className="hidden sm:flex items-center space-x-2">
                <button className="p-2 bg-pink-50 text-pink-600 dark:bg-pink-900/30 dark:text-pink-400 rounded-lg">
                ...
                >
                  ...
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute bottom-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button className="bg-pink-600 p-2 rounded-full shadow-md hover:bg-pink-700">
                  ...
                  <div className="p-4">
                    <Link 
                      ...
                      className="text-lg font-medium text-gray-800 dark:text-white hover:text-pink-600 dark:hover:text-pink-400 transition-colors"
                    >
                      {product.name}
                    </Link>
